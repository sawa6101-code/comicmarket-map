const CACHE='comicmarket-map-v7';
const ASSETS=['./','./index.html','./style.css','./app.js','./map-overrides.js','./manifest.json','./maps/east123.webp','./maps/west12.webp','./maps/east7.jpg','./maps/south12.jpg'];
