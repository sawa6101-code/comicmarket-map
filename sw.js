const CACHE='comicmarket-map-v15';
const ASSETS=['./','./index.html','./style.css?v=15','./event-layer.js?v=1','./app-v2.js?v=1','./pdf-map.js?v=1','./ui-fixes.js?v=1','./manifest.json','./maps/east123.webp','./maps/west12.webp','./maps/east7.jpg','./maps/south12.jpg'];
